...
#									return_elements=["BiasAdd_18"])
		...
		with tf.name_scope("Fc_ConcatGroup"):
			...
			print("Decouple Group dimension, shape = ", out.shape)  # shape = [b*u, 2*7*7*1024]
