...
PRETRAIN_MODEL_PATH_NAME = "./temp/G2D19_P2OF_ResHB_1LSTM_dataFeb_SurvDS_11/save_epoch_30/ViolenceNet.ckpt"
'''
...
MAX_TRAINING_EPOCH =5

EPOCHS_TO_START_SAVE_MODEL = 1
PATH_TO_SAVE_MODEL = "temp/G2D19_P2OF_ResHB_1LSTM_dataFeb_SurvDS_11.1"
