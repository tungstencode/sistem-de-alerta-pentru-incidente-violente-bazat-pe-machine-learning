...
PATH_TO_MODEL_CHECKPOINTS = "./temp/G2D19_P2OF_ResHB_1LSTM_dataFeb_SurvDS_10/save_epoch_29/ViolenceNet.ckpt"
# PATH_TO_MODEL_CHECKPOINTS = "./temp/G2D19_P2OF_ResHB_1LSTM_dataFeb_SurvDS_11/save_epoch_10/ViolenceNet.ckpt"
